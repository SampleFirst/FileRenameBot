...
TOKEN = os.environ.get("TOKEN", "5863223734:AAGatdy2YkYJw86eZG_sIWaF98qSwDb8Nyc")
# The Telegram API things
APP_ID = int(os.environ.get("APP_ID", "23906038"))
API_HASH = os.environ.get("API_HASH", "dff1eb42fad7971f16da662a99c0f376")
#Array to store users who are authorized to use the bot
ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '5217294686').split()]
#Your Mongo DB Database Name
DB_NAME = os.environ.get("DB_NAME", "Rename")
#Your Mongo DB URL Obtained From mongodb.com
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Rename:Rename@rename.idgn2xx.mongodb.net/?retryWrites=true&w=majority")
...
FORCE_SUB = os.environ.get("FORCE_SUB", "TrueDealsMaster")
